...
print_help () {
    echo ""
    echo "Usage: sh encrypt-host-setup-files.sh [OPTIONS]"
    echo ""
    echo "Encrypt host setup files using SOPS"
    echo ""
    echo "Options:"
    echo "  -h, --help"
    echo
    echo "Examples:"
    echo "  sh encrypt-host-setup-files"
}
...
sops \
  --output "./aws/credentials.encrypted.secret.shared" \
  --encrypt "./aws/credentials.secret.shared"
